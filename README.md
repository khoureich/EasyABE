...
The java version can be run in Visual Studio Code (VS Code). You must install the Extension Pack for Java in VS Code. Ensure you have a Java Development Kit (JDK 11 or newer) installed on your system.
