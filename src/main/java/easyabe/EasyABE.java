...
/**
 * This class is an implementation Easy-ABE From the paper "Easy-ABE: an Easy
 * Ciphertext-Policy Attribute-Based Encryption" Published in: SECITC 2022
 * Security Assumption: Computational Bilinear Diffie–Hellman Problem in Type-3
 * (CBDH-3)
 *
...
public class EasyABE {
    ...
    public static void setup(String curveParam) {
        pairing = PairingFactory.getPairing(curveParam);
